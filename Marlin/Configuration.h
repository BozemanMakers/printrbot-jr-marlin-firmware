...
#define STRING_CONFIG_H_AUTHOR "(Daniel Simser, Printerbot Jr v2 config)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duPREVENT_DANGEROUS_EXTRUDEty cycle to bed; 255=full current
...
// ***[BMS: COMMENTED ENDSTOPPULLUPS]***
//#define ENDSTOPPULLUPS // Comment this out (using // at the start of the line) to disable the endstop pullup resistors

// ***[BMS: ENABLED XMIN, YMIN, ZMIN ENDSTOPPULLUPS]***
